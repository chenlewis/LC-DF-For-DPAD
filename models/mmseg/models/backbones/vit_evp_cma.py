...
class VisionTransformerEVPcma(nn.Module):
    """ Vision Transformer with support for patch or hybrid CNN input stage
    """

    def __init__(self, model_name='SwinB', img_size=224, patch_size=16, in_chans=3, embed_dim=1024, depth=24,
        ...
        super(VisionTransformerEVPcma, self).__init__()
...
class PromptGenerator(nn.Module):
    ...
    def forward(self, x):
        ...
        #cma
        elif self.input_type == 'cma':
            x = self.cma(x, self.freq_nums)
        # get prompting
