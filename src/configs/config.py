...
# ----------------------------------------------------------------------
_C.MODEL = CfgNode()
_C.MODEL.TRANSFER_TYPE = "adapter"  # one of linear, end2end, prompt, adapter, side, partial-1, tinytl-bias
...
# _C.optimizer.args = CfgNode()
# _C.optimizer.args.lr = 2.e-4
# _C.optimizer.args.eps= 1e-8
# _C.optimizer.args.betas=(0.9, 0.999)
# _C.optimizer.args.weight_decay= 0.01

_C.optimizer.name = 'sgd'
_C.optimizer.args = CfgNode()
_C.optimizer.args.lr = 0.01
_C.optimizer.args.weight_decay= 0.001
...
_C.MODEL.name = "clas"
_C.MODEL.args = CfgNode()
_C.MODEL.args.inp_size = 224
_C.MODEL.args.loss = "bce"
_C.MODEL.args.encoder_mode = CfgNode()
_C.MODEL.args.encoder_mode.name = 'evcma'
_C.MODEL.args.encoder_mode.scale_factor = 32
_C.MODEL.args.encoder_mode.input_type = ""
_C.MODEL.args.encoder_mode.freq_nums = 0.25
_C.MODEL.args.encoder_mode.prompt_type = "highpass"
_C.MODEL.args.encoder_mode.tuning_stage = 1234
_C.MODEL.args.encoder_mode.handcrafted_tune = True
_C.MODEL.args.encoder_mode.embedding_tune = True
_C.MODEL.args.encoder_mode.adaptor = "adaptor"
_C.MODEL.args.encoder_mode.adapter_dim = 16
_C.MODEL.args.encoder_mode.patch_size = 16
_C.MODEL.args.encoder_mode.patch_size_prompt = 16
_C.MODEL.args.encoder_mode.search_size = 224
_C.MODEL.args.encoder_mode.template_size = 224
_C.MODEL.args.encoder_mode.pretrain = True
...
_C.DATA.ROTATE= True
_C.DATA.ROTATE_DEGREE= 30
_C.DATA.BLUR= True
_C.DATA.BLUR_KERNEL_SIZE=5
# _C.DATA.RESIZE= [256, 256]
# _C.DATA.CROP=224
